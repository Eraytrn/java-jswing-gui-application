...
/**
 * This class represents the GUI form for the Plan Meal Menu.
 */
public class PlanMealMenu extends javax.swing.JFrame {
	...
	/**
	 * Constructor to initialize the PlanMealMenu GUI.
	 */
	public PlanMealMenu() {
		setResizable(false);
		initComponents();
	...
	private void initComponents() {
		...
		jLabel2.setFont(new Font("Segoe UI", Font.BOLD, 24)); // NOI18N
		jLabel2.setText("Meal Menu");
		...
		btnNewButton_1 = new JButton("Remove Meal");
		...
		btnNewButton_2 = new JButton("List Meal");
	...
	/**
	 * Label for displaying information or prompting the user.
	 */
	...
	/**
	 * Panel for containing GUI components.
	 */
